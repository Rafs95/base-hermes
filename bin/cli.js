...
Commands:
  install, init     Copies the custom Hermes base installer files to your project folder under ./installer
  help, -h, --help  Display this help message

Options:
  -f, --force       Force copy files and overwrite if they already exist
  -d, --dir <path>  Specify a custom target directory instead of ./installer
  `);
}
...
function main() {
  ...
  let targetDir = path.join(process.cwd(), 'installer');
